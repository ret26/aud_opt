function test_suite = test_getObjV2
  initTestSuite;

% Tests: 
%
% 
% [obj,dobj] = getObjV2(y,Atar,g_gam,DS,fCutLP,ordLP,rho,kappa)
%
...
d=checkgrad('getObjV2',yinit,delta,Atar,g_gam,DS,fCutLP,ordLP,rho,kappa);
d
tol = 1e-4;
