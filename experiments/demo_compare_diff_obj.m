...
% an additional term to encourage the new signal to be different
% from the original

% this is a bit of a balancing act -- a very delicate business. first
% a term to control the squared error of the signal appears to be
% needed to stop the estimated signal blowing up. Then the
% magnitude of both of these terms need to be carefully set. I
% didn't find a satisfactory setting. It seemed like the term
% encouraging the squared signal to be small should be larger than
% the one encouraging the signal to be different from the
% original. Both needed to be quite small to stop the signal
% shrinking down too much.
...
[y2,info2] = match_envelopes_V1(yInit,ATar,g_gam,DS,fCutLP,ordLP,rho,numIts,y,1,1e-3,'linear',0);
...
savefile = '/home/rich/Data/aud_opt/demo_compare_diff_obj/';
